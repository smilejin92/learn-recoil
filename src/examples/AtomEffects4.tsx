...
/**
 * async selector vs. atom async effect
 * selector는 같은 input에 대하여 같은 output을 만드는 것에 사용 (derivedData from single source of truth)
 * atom async effect는 실시간으로 바뀌는 데이터(ex. refresh)를 다룰 때 사용하는 것이 유리
 */
